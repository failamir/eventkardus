                  ...
                  <div class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-enum :row="entry" field="payment">
                          </datatable-enum>
                        </td>
                      </tr>
                      <tr>
...
export default {
  ...
  computed: {
    ...mapGetters('PembayaransSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('PembayaransSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
